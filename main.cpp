...
int sc_main(int argc, char *argv[])
{
	...
	*/
	...
	sc_trace(VCDFile, TOP->cnn_blk->conv_blk1->conv_dp->s_mul1, "s_mul1");
	sc_trace(VCDFile, TOP->cnn_blk->conv_blk1->conv_dp->s_mul2, "s_mul2");
	sc_trace(VCDFile, TOP->cnn_blk->conv_blk1->conv_dp->sel3, "sel3");
	sc_trace(VCDFile, TOP->cnn_blk->conv_blk1->conv_dp->sel4, "sel4");
	sc_trace(VCDFile, TOP->cnn_blk->conv_blk1->conv_dp->s_add1, "s_add1");
	sc_trace(VCDFile, TOP->cnn_blk->conv_blk1->conv_dp->s_add2, "s_add2");
	sc_trace(VCDFile, TOP->cnn_blk->conv_blk1->conv_dp->sel1, "sel1");
	sc_trace(VCDFile, TOP->cnn_blk->conv_blk1->conv_dp->val0, "val0");
	sc_trace(VCDFile, TOP->cnn_blk->conv_blk1->conv_dp->val1, "val1");
	sc_trace(VCDFile, TOP->cnn_blk->conv_blk1->conv_dp->val2, "val2");
	sc_trace(VCDFile, TOP->cnn_blk->conv_blk1->conv_dp->val3, "val3");
